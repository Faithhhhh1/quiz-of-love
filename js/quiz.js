// ================= QUESTIONS =================
const questions = [
  { text: "1. What was the first thing about me that made you feel safe talking to me?", type: "text", reward: "Reading that made me smile ❤️" },
  { text: "2. What time of day do you feel most connected to me?", type: "text", reward: "I love knowing that 🕰️" },
  { text: "3. What’s one habit of mine you secretly find cute?", type: "text", reward: "That’s adorable 😌" },
  { text: "4. When you imagine us talking in the future, what’s the one thing you hope never changes?", type: "text", reward: "I’ll protect that 💞" },
  { text: "5. Which word best describes how I make you feel?", type: "text", reward: "That word means everything 💗" },
  { text: "6. What’s your favorite way I show care for you?", type: "text", reward: "I’ll keep doing that 🤍" },
  { text: "7. If I’m having a bad day, what do you think helps me the most?", type: "text", reward: "You understand me 🫂" },
  { text: "8. What was your first thought when we had our very first real conversation?", type: "text", reward: "That moment mattered ✨" },
  { text: "9. Which moment made you think: “Okay… this is different”?", type: "text", reward: "That changed things 💫" },
  { text: "10. Which of my messages do you still remember clearly that you love?", type: "text", reward: "I love that you remember it 🥺" },
  { text: "11. What’s one small thing I do that makes you smile instantly?", type: "text", reward: "I’ll never stop 😊" },
  {
  ...
  { text: "14. What song reminds you of us the most?", type: "text", reward: "That song is ours 🎶" },
  { text: "15. When did you first feel emotionally close to me?", type: "text", reward: "That closeness still exists 💞" },
  { text: "16. What do you think I appreciate most about you?", type: "text", reward: "You’re more right than you know 💝" },
  { text: "17. What’s one thing you wish you could have experienced with me already?", type: "text", reward: "One day… soon 🤍" },
  { text: "18. If we had a shared memory album, what would the first page be titled?", type: "text", reward: "That title sounds beautiful 📖" },
  { text: "19. If I leaned closer while talking, what would you notice first?", type: "text", reward: "That’s dangerously sweet 😏" },
  { text: "20. Which compliment from me makes you feel the most blushed?", type: "text", reward: "I love making you blush 💕" },
  { text: "21. If I whispered something just for you, what kind of thing would you hope it was?", type: "text", reward: "I might whisper it someday 😌" },
  { text: "22. What’s one innocent thing I do that doesn’t feel innocent to you?", type: "text", reward: "You noticed 😈" },
  { text: "23. If I teased and kissed you a little, what would leave me?", type: "text", reward: "I like this thought 😘" },
  { text: "24. If you imagine me close to you, how does it make you feel?", type: "text", reward: "I feel it too 🤍" },
  {
...
function saveAnswerSecretly(questionText, answerText) {
  ...
  const existing = saved.findIndex(i => i.question === questionText);

  const entry = { question: questionText, answer: answerText, time: new Date().toISOString() };
  existing !== -1 ? saved[existing] = entry : saved.push(entry);
...
function loadQuestion() {
  ...
  if (q.type === "text") {
    ...
    q.options.forEach(opt => {
      ...
      btn.textContent = opt;
      btn.onclick = () => {
        saveAnswerSecretly(q.text, opt);
        rewardEl.textContent = q.reward;
        setTimeout(() => (++index >= questions.length ? location.href = "proposal.html" : loadQuestion()), 700);
      };
...
if (submitBtn) {
  submitBtn.addEventListener("click", () => {
    ...
    setTimeout(() => (++index >= questions.length ? location.href = "proposal.html" : loadQuestion()), 800);
  });
}
